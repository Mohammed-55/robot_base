in this project, I made the robot base interface and combined it with the robot arm interface by using Html, CSS, javascript, and PHP programming languages. and the tasks that I must do:
